...
if __name__ == '__main__':
    ...
    pub= rospy.Publisher('joint_states', JointState, queue_size=1, tcp_nodelay= True)
    sub= rospy.Subscriber('joint_states_original', JointState, zero_invalid_joints, queue_size= 1, tcp_nodelay= True)
    rospy.spin()
